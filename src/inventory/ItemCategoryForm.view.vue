...
const moduleLabel = 'Category'
const errorMsg = ref('This field is required')

const breadcrumbItems = ref([
    {
        text: 'Inventory Category List',
        route: routeNames.inventoryItemCategory,
        isActive: false,
    },
    {
        text: 'Inventory Category Form',
        route: routeNames.inventoryItemCategoryForm,
        isActive: true,
    }
])
...
const onSubmit = async() => {
    ...
    router.push({name: routeNames.inventoryItemCategory})
