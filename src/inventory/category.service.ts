...
class ItemCategoryService{
    ...
    private endpoint = '/item-category/'
    private service = 'ItemCategoryService: '

    async findAll(): Promise<IItemCategory[]>{
    ...
    async findOne(id: string): Promise<IItemCategory | null>{
    ...
    async create(payload: {data: IItemCategory}): Promise<IItemCategory | null>{
    ...
    async update(payload: {id: string, data: IItemCategory}): Promise<IItemCategory | null>{
