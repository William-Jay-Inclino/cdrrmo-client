            ...
            <div class="col-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">List of CSO</h6>
                        <router-link :to="{name: routeNames.csosForm}">
                            <button class="btn btn-primary" type="button">Add CSO</button>
                        </router-link>
                    </div>
...
const onDelete = async(item: ICSO) => {
...
const onClickUpdateIcon = (data: ICSO) => {
    router.push({name: routeNames.csosForm, query: {id: data.id}})
}
