            ...
            <div class="col-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">List of BART</h6>
                        <router-link :to="{name: routeNames.bartsForm}">
                            <button class="btn btn-primary" type="button">Add BART</button>
                        </router-link>
                    </div>
...
const onDelete = async(item: IBART) => {
...
const onClickUpdateIcon = (data: IBART) => {
    router.push({name: routeNames.bartsForm, query: {id: data.id}})
}
