...
class BartService{
    ...
    private endpoint = '/bart/'
    private service = 'BartService: '

    async findAll(): Promise<IBART[]>{
    ...
    async findOne(id: string): Promise<IBART | null>{
    ...
    async create(payload: {data: IBART}): Promise<IBART | null>{
    ...
    async update(payload: {id: string, data: IBART}): Promise<IBART | null>{
...
export const bartService = new BartService()