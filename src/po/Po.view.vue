<template>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PO (People's Organization) Module</h1>
        </div>
            ...
            <div class="col-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">List of PO</h6>
                        <router-link :to="{name: routeNames.posForm}">
                            <button class="btn btn-primary" type="button">Add PO</button>
                        </router-link>
                    </div>
...
const onClickUpdateIcon = (data: IPO) => {
    router.push({name: routeNames.posForm, query: {id: data.id}})
}
