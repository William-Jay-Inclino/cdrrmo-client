...
class NaService{
    ...
    private endpoint = '/na/'
    private service = 'NaService: '

    async findAll(): Promise<INa[]>{
    ...
    async findOne(id: string): Promise<INa | null>{
    ...
    async create(payload: {data: INa}): Promise<INa | null>{
    ...
    async update(payload: {id: string, data: INa}): Promise<INa | null>{
...
export const naService = new NaService()