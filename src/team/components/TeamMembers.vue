                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td v-if="false" class="align-middle text-center">
                        ...
                        <tr v-show="false">
                            <td class="align-middle">
                                <select @change="() => console.log('remove')" class="form-control">
                                    <option>
                                        {{ "user.first_name + ' ' + user.last_name" }}
                                    </option>
                                </select>
                                <small class="form-text text-danger" v-show="false">Select Personnel</small>
                            </td>
                            <td>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                            ...
                            <td class="text-center align-middle">
                                <button @click="() => console.log('onSave')" v-if="false" class="btn btn-success btn-sm" :class="{'disabled': !false}">
                                    <span>Save</span>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td v-if="false" class="text-center" colspan="4">
                                <button v-if="!false" @click="() => console.log('onAdd')" class="btn btn-outline-primary btn-sm btn-block">
                                    <i class="fas fa-fw fa-plus"></i>
                                </button>
                                <button @click="false" v-else class="btn btn-outline-dark btn-sm btn-block">
                                    Cancel
                                </button>
                            </td>
                        </tr>
