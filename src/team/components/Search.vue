        ...
        <div class="input-group-append">
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    ...
                    <a @click="onChangeRef(SearchFieldEnum.Lastname)" class="dropdown-item" href="#">TL Lastname</a>
                    <a @click="onChangeRef(SearchFieldEnum.Firstname)" class="dropdown-item" href="#">TL Firstname</a>
                </div>
                </div>
        </div>
    </div>
